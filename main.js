...
function draw() {
    ...
    strokeWeight(13);
    //definir cor do traço como poreta
    stroke(0);
    //Se o mouse for precionado, desenhe uma linha entre as posições anterior e atual do mouse
    if(mouseIsPressed) {
...
function gotResult(error, results) {
    ...
    document.getElementById('confidence').innerHTML = 'Pre'
}
